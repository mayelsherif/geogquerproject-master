...
\begin{algorithmic}[1]
    \Function{selectUsersFromGrid }{$FSP, N$}
        ...
        \EndIf \Comment{(b) Get kNN for pivot users depending on quota or maximize dispersion}\\
      \State firstStageQuota = calculateQuota(firstStageUsers)
      
      \For{$user_i$ in firstStageUsers}\\ \Comment{Aggregate selected users}
...
\begin{table*}[t]
  \centering
  \begin{tabular}{ccc}
     \includegraphics[width=0.33\textwidth, height=5cm]{figuresPng/Paris.png}&  \includegraphics[width=0.33\textwidth, height=5cm]{figuresPng/Brussels.png} & \includegraphics[width=0.33\textwidth, height=5cm]{figuresPng/Istanbul.png}\\ 
